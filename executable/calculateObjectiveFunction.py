...
def main():
    ...
    output_filename = f"himmelblau.dat"
    config_filename = "himmelblau.cfg"
    ...
    try:
        function_value = himmelblauOpt.evaluateFunction(dv)
    except Exception as e:
        print(f"Error evaluating Himmelblau function: {e}", file=sys.stderr)
        sys.exit(1)
